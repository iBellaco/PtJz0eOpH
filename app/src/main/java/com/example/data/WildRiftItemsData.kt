...
object WildRiftItemsData {
    val list: List<WildRiftItem> = listOf(
        ...
        WildRiftItem(
            ...
            coachTip = "Este objeto amplifica enormemente tu poder de ataque automático al aumentar el daño base de los golpes críticos al 230% y otorgar daño crítico adicional cuando tu probabilidad total de crítico de los objetos está limitada. — Perfecto para tiradores y luchadores de ataque automático que buscan maximizar su daño crítico.",
            coachTipEn = "This item greatly amplifies your auto‑attack power by boosting the base damage of critical strikes to 230% and granting extra critical damage when your total crit chance from items is capped. — Perfect for marksmen and auto‑attack fighters looking to maximize their crit damage.",
        ...
        WildRiftItem(
            ...
            category = "Objetos con Daños Físicos",
            goldCost = 2900,
            stats = "+25 Daño de ataque • +300 Maná máximo • +20 Velocidad de habilidad",
            statsEn = "+25 Attack Damage • +300 Max Mana • +20 Ability Haste",
            passive = "Pavor: Otorga Daño de ataque equivalente al 1.5% del Maná máximo y reembolsa el 15% de todo el Maná gastado.\nCarga de maná: Aumenta el Maná máximo en 18 con cada ataque o al gastar Maná. Se acumula hasta 700 de Maná adicional, transformando Manamune en Muramana. Se activa hasta 3 veces cada 10 segundos. Solo puedes llevar un objeto de Lágrima de la Diosa a la vez.",
            ...
            coachTip = "Objeto perfecto para campeones de daño físico que dependen del maná y sus habilidades para infligir daño. Otorga daño de ataque, maná máximo y velocidad de habilidad. Su pasiva Carga de Maná aumenta el maná máximo hasta transformarse en Muramana al llegar al límite, potenciando enormemente los ataques y habilidades de campeones como Ezreal o Twitch.",
        ...
        WildRiftItem(
            ...
            passive = "Sombra: Los ataques infligen 35 de daño mágico adicional al impactar.\nYuxtaposición: Alterna entre Luz y Oscuridad al atacar. Los ataques de Luz otorgan 5-8 de Armadura y Resistencia mágica durante 5 segundos al impactar. Los ataques de Oscuridad otorgan 11% de Penetración de armadura y 11% de Penetración mágica durante 5 segundos al impactar. Cada efecto al impactar se acumula hasta 3 veces. Límite máximo de penetración: 40%.",
            ...
            coachTip = "Ideal para campeones basados en ataques automáticos continuos que se benefician de penetración mixta (armadura y resistencia mágica) y resistencias acumulables en combates prolongados.",
        ...
        WildRiftItem(
            ...
            category = "Defensa",
            goldCost = 2550,
            stats = "+250 Salud • +50 Armadura • +10 Velocidad de Habilidad",
            statsEn = "+250 Health • +50 Armor • +10 Ability Haste",
            passive = "Resistencia adaptativa: Al recibir daño físico o mágico de campeones, otorga armadura y resistencia mágica adicional durante el combate.",
        ...
        WildRiftItem(
            ...
            category = "Objetos con Daños Físicos",
            goldCost = 3200,
            stats = "+40 Daño de Ataque • +25% Tasa Crítica • +15% Velocidad de Ataque",
            statsEn = "+40 Attack Damage • +25% Critical Rate • +15% Attack Speed",
            passive = "Línea de Vida: Si vas a recibir daño que reduzca tu vida por debajo del 35%, obtienes un escudo de 200-400 (según el nivel, escala con la tasa crítica) durante 5 s y un 10% de vampirismo físico durante 8 s (enfriamiento de 90 s).",
        ...
        WildRiftItem(
            ...
            category = "Objetos Defensivos",
            goldCost = 3200,
            stats = "+55 Armadura • +55 Resistencia Mágica",
            statsEn = "+55 Armor • +55 Magic Resist",
            passive = "Coraza de Amarante: Cada segundo en combate con campeones otorga una acumulación (máx. 5). Al máximo de acumulaciones, aumentan la Armadura y Resistencia Mágica adicionales en un 30% y obtienes un 20% de tenacidad hasta salir del combate.",
        ...
        WildRiftItem(
            ...
            category = "Objetos Defensivos",
            goldCost = 3000,
            stats = "+400 Salud Máxima • +55 Armadura • +15 Aceleración de Habilidad",
            statsEn = "+400 Max Health • +55 Armor • +15 Ability Haste",
            passive = "Angustia: Cada 4 s en combate con campeones enemigos, inflige daño mágico equivalente al 3% de la salud máxima a los enemigos cercanos y te cura por el 100% del daño infligido.",
        ...
        WildRiftItem(
            ...
            category = "Objetos con Daños Físicos",
            goldCost = 2900,
            stats = "+25 Daño de Ataque • +25% Tasa Crítica • +35% Velocidad de Ataque • +5% Vel. de Movimiento",
            statsEn = "+25 Attack Damage • +25% Critical Rate • +35% Attack Speed • +5% Move Speed",
            passive = "Energizado: Moverse y atacar genera un ataque energizado.\nFrancotirador: Los ataques energizados obtienen hasta +150 de alcance de ataque (o 35% de alcance adicional) y causan 60-140 de daño mágico adicional.",
        ...
        WildRiftItem(
            ...
            category = "Objetos de Apoyo",
            goldCost = 2400,
            stats = "+55 Poder de Habilidad • +15 Aceleración de Habilidad • +200 Maná",
            statsEn = "+55 Ability Power • +15 Ability Haste • +200 Mana",
            passive = "Susurro de Vida: Aumenta la potencia de tus curaciones y escudos otorgados a aliados.",
            passiveEn = "Whisper of Life: Increases the strength of your heals and shields granted to allies.",
            coachTip = "Excelente para soportes encantadores que buscan maximizar la curación y mitigación de daño en su equipo.",
