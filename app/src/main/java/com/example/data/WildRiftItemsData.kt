...
object WildRiftItemsData {
    val list: List<WildRiftItem> = listOf(
        ...
        WildRiftItem(
            ...
            passive = "Vigilia nocturna: Otorga 20 de velocidad de habilidad definitiva.\nAndanada inicial: Tras lanzar tu habilidad definitiva, tus siguientes 3 ataques en los próximos 8 s obtienen un 50% de velocidad de ataque y asestan impactos críticos, que infligen un 80% de tu daño de impacto crítico normal. Si un ataque fuera a infligir un impacto crítico, inflige un 15% de daño verdadero adicional (45 s de enfriamiento).",
            passiveEn = "Night Vigil: Gain 20 Ultimate Ability Haste.\nOpening Barrage: After casting your ultimate, your next 3 attacks within 8s gain 50% Attack Speed and Critically Strike, dealing 80% normal critical damage. If an attack would critically strike, deal 15% bonus true damage instead (45s Cooldown).",
            coachTip = "Excelente objeto para tiradores y campeones de daño físico que dependen de su habilidad definitiva para iniciar el combate. Al activar la definitiva, potencia tus siguientes 3 ataques con gran velocidad de ataque, golpes críticos garantizados y daño verdadero adicional.",
            coachTipEn = "A top tier item for marksmen who rely on their ultimate ability. After casting your ultimate, it empowers your next 3 attacks with high attack speed, guaranteed crits, and bonus true damage.",
            iconUrl = "file:///android_asset/offline_images/fiendhunter_bolts.png"
        ),
        WildRiftItem(
            id = "rapid_firecannon",
            ...
            category = "Objetos con Daños Físicos",
            goldCost = 2650,
            stats = "+25% Probabilidad de crítico • +40% Velocidad de ataque • +4% Velocidad de movimiento",
            statsEn = "+25% Critical Rate • +40% Attack Speed • +4% Move Speed",
            passive = "Francotirador: Al moverte y atacar generas un ataque con vigor con un 35% de alcance de ataque adicional (máx. 150 de alcance), que inflige 80 de daño mágico adicional.",
            passiveEn = "Sharpshooter: Moving and attacking generates an Energized attack with 35% bonus attack range (max 150 range), dealing 80 bonus magic damage.",
            coachTip = "Aumenta el alcance de ataque de tu primer golpe energizado, permitiendo golpear a enemigos desde una distancia segura antes de iniciar una pelea o durante el desgaste en fase de líneas.",
            coachTipEn = "Increases attack range on your first energized strike, allowing you to poke safely from a long distance before teamfights.",
            iconUrl = "https://ddragon.leagueoflegends.com/cdn/14.18.1/img/item/3094.png"
        ),
        WildRiftItem(
            id = "hextech_c44_optics",
            name = "Óptica hextech C44",
            nameEn = "Hextech C44 Optics",
            category = "Objetos con Daños Físicos",
            goldCost = 2900,
            stats = "+55 Daño de ataque • +25% Probabilidad de crítico",
            statsEn = "+55 Attack Damage • +25% Critical Rate",
            passive = "Magnificación: Inflige un 0-10% de daño adicional con ataques, según la distancia a la que se encuentre el enemigo (daño máximo a 550 de alcance).\nPuntería arcana: Cuando un campeón al que has infligido daño en los últimos 3 s muere, otorga 100 de alcance de ataque adicional durante 8 s.",
            passiveEn = "Magnification: Attacks deal 0-10% bonus damage based on distance to the target (max at 550 range).\nArcane Aim: Scoring a takedown on an enemy damaged within 3s grants 100 bonus attack range for 8s.",
            coachTip = "Ideal para tiradores de largo alcance. Incrementa el daño en función de la distancia al objetivo y otorga +100 de alcance de ataque tras participar en la eliminación de un campeón.",
            coachTipEn = "Ideal for long-range marksmen. Scales damage based on target distance and grants +100 bonus attack range after scoring a takedown.",
            iconUrl = "file:///android_asset/offline_images/hextech_c44_optics.png"
        ),
        WildRiftItem(
            id = "statikk_shiv",
            ...
            category = "Objetos con Daños Físicos",
            goldCost = 3000,
            stats = "+40 Daño de ataque • +30% Velocidad de ataque • +40 Poder de habilidad • +4% Velocidad de movimiento",
            statsEn = "+40 Attack Damage • +30% Attack Speed • +40 Ability Power • +4% Move Speed",
            passive = "Electrochoque: Los ataques otorgan 5 acumulaciones de vigor adicionales.\nElectrochispa: Moverte y atacar genera un ataque con vigor que emite rayos que rebotan a 4-7 objetivos, lo que inflige 60 de daño mágico (aumenta hasta 90 de daño mágico contra súbditos y monstruos y aplica efectos de impacto al rebotar a otros objetivos).",
            passiveEn = "Electroshock: Attacks grant 5 additional Energized stacks.\nElectrospark: Moving and attacking generates an Energized attack that unleashes chain lightning hitting 4-7 targets for 60 magic damage (up to 90 vs minions/monsters and triggers on-hit effects).",
            coachTip = "Gran opción para tiradores que buscan acelerar la limpieza de oleadas de súbditos e infligir daño en cadena a múltiples objetivos durante las peleas en equipo.",
            coachTipEn = "Great choice for marksmen looking to clear minion waves rapidly and deliver chain lightning damage to multiple enemies in teamfights.",
            iconUrl = "https://ddragon.leagueoflegends.com/cdn/14.18.1/img/item/3087.png"
        ),
        WildRiftItem(
            id = "stormrazor",
            ...
            category = "Objetos con Daños Físicos",
            goldCost = 3000,
            stats = "+50 Daño de ataque • +25% Probabilidad de crítico • +20% Velocidad de ataque",
            statsEn = "+50 Attack Damage • +25% Critical Rate • +20% Attack Speed",
            passive = "Proyectil: Al moverte y atacar generas un ataque con vigor que inflige 120 de daño mágico adicional y otorga un 45% de velocidad de movimiento durante 1,5 s al impactar.",
            passiveEn = "Paralyze: Moving and attacking generates an Energized attack dealing 120 bonus magic damage and granting 45% Movement Speed for 1.5s on hit.",
            coachTip = "Proporciona una gran ráfaga de daño mágico adicional y un impulso instantáneo de velocidad de movimiento en tu ataque energizado, facilitando el reposicionamiento y la persecución.",
            coachTipEn = "Delivers a burst of bonus magic damage and a quick burst of movement speed on energized attacks for fast repositioning.",
            iconUrl = "https://ddragon.leagueoflegends.com/cdn/14.18.1/img/item/3124.png"
        ),
        WildRiftItem(
            ...
            passive = "La práctica hace al asesino: Al atacar, obtienes probabilidad de crítico permanente (0,4% para campeones cuerpo a cuerpo y 0,2% para campeones a distancia por ataque), hasta un máximo de 25%.\nRáfaga: Al atacar a un campeón enemigo, obtienes un 25% de velocidad de ataque durante 6 s (20 s de enfriamiento). Los ataques reducen el enfriamiento 1 s o 2 s si son impactos críticos.",
            passiveEn = "Practice Makes Lethal: Basic attacks permanently grant critical strike chance (0.4% melee / 0.2% ranged per hit, capped at 25%).\nFlurry: Attacking an enemy champion grants 25% Attack Speed for 6s (20s Cooldown). Attacks reduce cooldown by 1s (2s on crit).",
            coachTip = "Permite escalar probabilidad de crítico permanente conforme golpeas con ataques básicos y otorga una potente bonificación de velocidad de ataque en combate.",
            coachTipEn = "Allows you to scale permanent critical strike chance with basic attacks and provides a massive burst of attack speed in champion combat.",
            iconUrl = "https://ddragon.leagueoflegends.com/cdn/14.18.1/img/item/3032.png"
        ),
        WildRiftItem(
            id = "luden_s_echo",
            name = "Eco de Luden",
    ...
    private val itemAliases: Map<String, String> = mapOf(
        ...
        "dardos rastreademonios" to "fiendhunter_bolts",
        "fiendhunter bolts" to "fiendhunter_bolts",
        "los dardos rastreademonios" to "fiendhunter_bolts",
        "hextech c44 optics" to "hextech_c44_optics",
        "optica hextech c44" to "hextech_c44_optics",
        "óptica hextech c44" to "hextech_c44_optics",
        "la optica hextech c44" to "hextech_c44_optics",
        "la óptica hextech c44" to "hextech_c44_optics",
